 ...
 * Path the same distance back to the start. Rinse and repeat! This is good for testing a variety of
 * Vectors, like the drive Vector, the translational Vector, the heading Vector, and the centripetal
 * Vector. Remember to test your tunings on StraightBackAndForth as well, since tunings that work
 * well for curves might have issues going in straight lines.
 *
